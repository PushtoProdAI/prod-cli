...
// / Streaming version of DebugExtractIntent
func (*stream) DebugExtractIntent(ctx context.Context, request string, opts ...CallOptionFunc) (<-chan StreamValue[string, string], error) {
	...
	if err != nil {
		// This should never happen. if it does, please file an issue at https://github.com/boundaryml/baml/issues
		// and include the type of the args you're passing in.
		wrapped_err := fmt.Errorf("BAML INTERNAL ERROR: DebugExtractIntent: %w", err)
		panic(wrapped_err)
	}

	internal_ctx := context.Background()
	internal_channel, err := bamlRuntime.CallFunctionStream(internal_ctx, "DebugExtractIntent", encoded)
	if err != nil {
		return nil, err
	}
...
func (*stream) DetermineBuildOutput(ctx context.Context, candidate types.BuildOutputCandidate, opts ...CallOptionFunc) (<-chan StreamValue[stream_types.BuildOutput, types.BuildOutput], error) {
	...
	internal_ctx := context.Background()
	internal_channel, err := bamlRuntime.CallFunctionStream(internal_ctx, "DetermineBuildOutput", encoded)
	if err != nil {
		return nil, err
	}
