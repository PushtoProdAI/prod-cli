...
const (
	...
	AgentEstimateContainerCosts     = "agent.estimateContainerCosts"
	...
	AgentVerifyLiveness             = "agent.verifyLiveness"
...
type Activities struct {
	...
	history           *history.Store // local deployment history (local mode); nil-safe
}
...
func (a *Activities) Activities() []workflowext.Activity {
	return []workflowext.Activity{
		...
		{Name: AgentEstimateContainerCosts, ActFunc: a.estimateContainerCosts},
		...
		{Name: AgentVerifyLiveness, ActFunc: a.verifyLiveness},
